<template>
  <div class="pane-inspector">
    <edit-tabs :items='items' :inactive="inactive" :hideTabs="lowDetail" v-model:active_item="appParams.inspector_tab" padding="0px;" :storageKey="storageKey" :paneResize="paneResize" @visibleChanged="onVisibleChanged">
