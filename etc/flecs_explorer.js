...
["_main","_memory","___original_main","_has_startup_script_param","___indirect_function_table","__sapp_emsc_notify_keyboard_hidden","__sapp_emsc_onpaste","__sapp_html5_get_ask_leave_site","__sapp_emsc_begin_drop","__sapp_emsc_drop","__sapp_emsc_end_drop","__sapp_emsc_invoke_fetch_cb","__sapp_emsc_capture_keyboard_events","___em_lib_deps_sokol_app","_sapp_js_create_textfield","_sapp_js_focus_textfield","_sapp_js_unfocus_textfield","_sapp_js_add_beforeunload_listener","_sapp_js_remove_beforeunload_listener","_sapp_js_add_clipboard_listener","_sapp_js_remove_clipboard_listener","_sapp_js_write_clipboard","_sapp_js_add_dragndrop_listeners","_sapp_js_dropped_file_size","_sapp_js_fetch_dropped_file","_sapp_js_remove_dragndrop_listeners","_sapp_js_add_capture_keyboard_events","_sapp_js_init","_sapp_js_request_pointerlock","_sapp_js_exit_pointerlock","_sapp_js_set_cursor","_sapp_js_clear_favicon","_sapp_js_set_favicon","_slog_js_log","___emscripten_embedded_file_data","_fflush","___start_em_js","___stop_em_js","___start_em_lib_deps","___stop_em_lib_deps","___set_stack_limits","onRuntimeInitialized"].forEach((prop) => {
...
var wasmBinaryFile;
  wasmBinaryFile = 'flecs_explorer.wasm';
...
function has_startup_script_param() { if (typeof window === "undefined" || typeof URLSearchParams === "undefined") { return false; } const params = new URLSearchParams(window.location.search || ""); return params.has("code") || params.has("code_url"); }
...
function sapp_js_add_capture_keyboard_events() { Module.sokol_capture_keyboard_events = function(capture) { __sapp_emsc_capture_keyboard_events(capture); }; }
...
// end include: preamble.js
  ...
  var fillPointerlockChangeEventData = (eventStruct) => {
      ...
      /** @suppress{checkTypes} */
      HEAP32[((eventStruct)>>2)] = isPointerlocked;checkInt32(isPointerlocked);
  ...
  var registerUiEventCallback = (target, userData, useCapture, callbackfunc, eventTypeId, eventTypeString, targetThread) => {
      ...
      var uiEventHandlerFunc = (e = event) => {
        ...
        HEAP32[((uiEvent)>>2)] = e.detail;checkInt32(e.detail);
        ...
        HEAP32[(((uiEvent)+(28))>>2)] = pageXOffset;checkInt32(pageXOffset);
        HEAP32[(((uiEvent)+(32))>>2)] = pageYOffset;checkInt32(pageYOffset);
  ...
  var registerWheelEventCallback = (target, userData, useCapture, callbackfunc, eventTypeId, eventTypeString, targetThread) => {
      ...
      var wheelHandlerFunc = (e = event) => {
        ...
        HEAP32[(((wheelEvent)+(96))>>2)] = e["deltaMode"];checkInt32(e["deltaMode"]);
  ...
  var emscriptenWebGLGet = (name_, p, type) => {
            ...
            if (result === null) {
              ...
              for (var i = 0; i < result.length; ++i) {
                switch (type) {
                  ...
                  case 4: HEAP8[(((p)+(i))>>0)] = result[i] ? 1 : 0;checkInt8(result[i] ? 1 : 0); break;
                }
              }
              return;
            } else {
      ...
      switch (type) {
        ...
        case 4: HEAP8[((p)>>0)] = ret ? 1 : 0;checkInt8(ret ? 1 : 0); break;
      }
    };
...
var wasmImports = {
  ...
  /** @export */
  has_startup_script_param: has_startup_script_param,
  /** @export */
  sapp_js_add_beforeunload_listener: sapp_js_add_beforeunload_listener,
  /** @export */
  sapp_js_add_capture_keyboard_events: sapp_js_add_capture_keyboard_events,
  /** @export */
...
var __sapp_emsc_capture_keyboard_events = Module['__sapp_emsc_capture_keyboard_events'] = createExportWrapper('_sapp_emsc_capture_keyboard_events');
...
var ___emscripten_embedded_file_data = Module['___emscripten_embedded_file_data'] = 1230260;
var ___start_em_js = Module['___start_em_js'] = 1323272;
var ___stop_em_js = Module['___stop_em_js'] = 1329686;
...
if (typeof exports === 'object' && typeof module === 'object')
  module.exports = flecs_explorer;
else if (typeof define === 'function' && define['amd'])
  define([], () => flecs_explorer);
